...
function Contribute() {
  ...
  return (
    <div>
      {
        //  create full screen loading bg-black opcitiy-50 fixed top-0 left-0 right-0 bottom-0 z-50
        handling && (
          <div className="fixed top-0 left-0 right-0 bottom-0 z-50 bg-black opacity-70">
            <h2 className="absolute top-1/2 left-1/2 -translate-x-1/2 text-xl">
              <span className="text-white animate-pulse">
                Đang xử lý, bạn vui lòng đợi 1 lát nhé...
              </span>
            </h2>
          </div>
        )
