...
function RecipesList({ recipes }: { recipes: Recipe[] }) {
  return (
    <div className="w-full overflow-hidden relative h-full rounded-md p-2 md:p-10 text-xl md:text-4xl font-bold text-white bg-gradient-to-br from-purple-400 to-blue-900">
